...
namespace deeprockitems.Common.Quests
{
    public class QuestSystem : ModSystem
    {
        ...
        {
            Quests.Add(QuestID.Fighting, NPCID.BlueSlime, 30, true)
                .Add(QuestID.Fighting, NPCID.DemonEye, 20, !Main.hardMode)
                .Add(QuestID.Fighting, NPCID.WanderingEye, 10, Main.hardMode)
                .Add(QuestID.Fighting, NPCID.Zombie, 20, true)
                .Add(QuestID.Fighting, NPCID.Skeleton, 20, true)
                .Add(QuestID.Fighting, NPCID.GreekSkeleton, 15, true)
                .Add(QuestID.Fighting, NPCID.GraniteFlyer, 15, true)
                .Add(QuestID.Fighting, NPCID.GraniteGolem, 15, true)
                .Add(QuestID.Fighting, NPCID.Medusa, 5, Main.hardMode)
                .Add(QuestID.Fighting, NPCID.Demon, 15, NPC.downedBoss2)
                .Add(QuestID.Fighting, NPCID.FireImp, 10, NPC.downedBoss2)
                .Add(QuestID.Fighting, NPCID.RedDevil, 10, NPC.downedMechBossAny)
                .Add(QuestID.Fighting, NPCID.CaveBat, 15, !Main.hardMode)
                ...
                .Add(QuestID.Fighting, NPCID.ChaosElemental, 5, Main.hardMode)
                .Add(QuestID.Fighting, NPCID.AngryBones, 15, NPC.downedBoss3)
                ;
        }
        private void RecalculateGatheringQuests()
        {
            ...
            Quests.Add(QuestID.Gathering, ItemID.Daybloom, 10, true)
                ...
                // Dye plants
                .Add(QuestID.Gathering, ItemID.YellowMarigold, 3, true)
                .Add(QuestID.Gathering, ItemID.OrangeBloodroot, 3, true)
                .Add(QuestID.Gathering, ItemID.TealMushroom, 3, true)
                .Add(QuestID.Gathering, ItemID.GreenMushroom, 3, true)
                .Add(QuestID.Gathering, ItemID.LimeKelp, 3, true)
                .Add(QuestID.Gathering, ItemID.SkyBlueFlower, 3, true)
                .Add(QuestID.Gathering, ItemID.BlueBerries, 3, true)
                .Add(QuestID.Gathering, ItemID.PinkPricklyPear, 3, true)
                // Shrooms
        ...
        private void RecalculateMiningQuests()
        {
            if (WorldGen.SavedOreTiers.Copper != -1 && Main.netMode != NetmodeID.MultiplayerClient)
            {
                ...
                Quests.Add(QuestID.Mining, ItemID.CopperOre, 100, WorldGen.SavedOreTiers.Copper == TileID.Copper)
                    .Add(QuestID.Mining, ItemID.TinOre, 100, WorldGen.SavedOreTiers.Copper == TileID.Tin)
                    .Add(QuestID.Mining, ItemID.IronOre, 75, WorldGen.SavedOreTiers.Iron == TileID.Iron)
                    .Add(QuestID.Mining, ItemID.LeadOre, 75, WorldGen.SavedOreTiers.Iron == TileID.Lead)
                    .Add(QuestID.Mining, ItemID.SilverOre, 60, WorldGen.SavedOreTiers.Silver == TileID.Silver)
                    .Add(QuestID.Mining, ItemID.TungstenOre, 60, WorldGen.SavedOreTiers.Silver == TileID.Tungsten)
                    .Add(QuestID.Mining, ItemID.GoldOre, 60, WorldGen.SavedOreTiers.Gold == TileID.Gold)
                    .Add(QuestID.Mining, ItemID.PlatinumOre, 60, WorldGen.SavedOreTiers.Gold == TileID.Platinum)
                    // Evil ores
                    .Add(QuestID.Mining, ItemID.DemoniteOre, 75, NPC.downedBoss2 && !WorldGen.crimson)
                    .Add(QuestID.Mining, ItemID.CrimtaneOre, 75, NPC.downedBoss2 && WorldGen.crimson)
                    // Gems and hellstone
                    .Add(QuestID.Mining, ItemID.Hellstone, 50, NPC.downedBoss2)
                    .Add(QuestID.Mining, ItemID.Amethyst, 25, true)
                    .Add(QuestID.Mining, ItemID.Topaz, 25, true)
                    .Add(QuestID.Mining, ItemID.Sapphire, 20, true)
                    .Add(QuestID.Mining, ItemID.Emerald, 15, true)
                    .Add(QuestID.Mining, ItemID.Ruby, 10, true)
                    .Add(QuestID.Mining, ItemID.Diamond, 5, true)
                    .Add(QuestID.Mining, ItemID.Amber, 10, true)
